using ProjectPlatoV2.Forms.Items.Backblings;
using System;
...
{
    public partial class Backblings : Form
    {
        public Backblings()
        {
            InitializeComponent();
        ...
        {
            BlackShieldOptions popup = new BlackShieldOptions();
            popup.Show();
        }

        private void bunifuImageButton2_Click(object sender, EventArgs e)
        {
            LoveWings popup = new LoveWings();
            popup.Show();
        }

        private void bunifuImageButton3_Click(object sender, EventArgs e)
        {
            IronCage popup = new IronCage();
            popup.Show();
        }

        private void bunifuImageButton4_Click(object sender, EventArgs e)
        {
            BattleShroud popup = new BattleShroud();
            popup.Show();
        }

        private void bunifuImageButton5_Click(object sender, EventArgs e)
        {
            HazardBow popup = new HazardBow();
            popup.Show();
        }
    }
}
