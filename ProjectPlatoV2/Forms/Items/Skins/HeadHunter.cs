...
namespace ProjectPlatoV2.Forms.Items.Skins
{
    public partial class HeadHunter : Form
    {
        public HeadHunter()
        {
            ...
            if (Settings.Default.headhuntercvt == true)
            {
        ...
        string Mat1 = "Skins/BR_05/MaterialED_Cmmando1BR05";
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            if (Settings.Default.headhuntercvt != true)
            {
                ...
                Settings.Default.headhuntercvt = true;
            ...
            else
            {
                ...
                DarkMessageBoxHelper.DMB("Swapping Update", "Done swapping!");
                Settings.Default.headhuntercvt = false;
                Settings.Default.Save();
                pictureBox1.BackgroundImage = Resources.ConvertButton;
            }
        }
